...
namespace ManejoPresupuesto.Servicios
{
    public interface IServicioReportes
    {
        ...
        Task<ReporteTransaccionesDetalladas> ReporteTransaccionesDetalladasPorCuenta(int usuarioId, int cuentaId, int mes, int año, dynamic ViewBag);
    }
    public class ServicioReportes: IServicioReportes
    {
            ...
            ObtenerReporteTransaccionesDetalladas(int usuarioId, int mes, int año, dynamic ViewBag)
        {
            ...
            var transacciones = await repositorioTransacciones.ObtenrPorUsuarioId(parametro);

            var modelo = GenerarTransaccionesDetalladas(fechaInicio, fechaFin, transacciones);
        ...
        public async Task<ReporteTransaccionesDetalladas> 
            ReporteTransaccionesDetalladasPorCuenta(int usuarioId, int cuentaId, 
            int mes, int año, dynamic ViewBag)
        {
            ...
            var transacciones = await repositorioTransacciones
                .ObtenrPorCuentaId(obtenerTransaccionesPorCuenta);
        ...
        private static ReporteTransaccionesDetalladas GenerarTransaccionesDetalladas(DateTime fechaInicio, DateTime fechaFin, IEnumerable<Transaccion> transacciones)
        {
